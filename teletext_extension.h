...
enum colour {BLACK=0x80 ,RED, GREEN, YELLOW, BLUE, MAGENTA,
               CYAN, WHITE, TEAL, ORANGE, PINK, LGREEN};
typedef enum mode {Alphanumeric, Graphics} Mode;
typedef enum type {Contiguous, Separated} Type;
typedef enum height {Single, Double, Infinite} Height;
